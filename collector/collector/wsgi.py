...
def append_extra_data():
    isp_types = ['default', 'airpipe-wireless', 'century-link', 'comcast', 'charter', 'cougar-wireless', 'desert-winds-wireless', 'dish-net', 'ecliptixnet-wireless', 'excede', 'hughes-net', 'ptera-wireless', 'wild-blue', 'other']
