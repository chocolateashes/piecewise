...
def append_extra_data():
    isp_types = ['default', 'airpipe-wireless', 'att', 'century-link', 'comcast', 'charter', 'cougar-wireless', 'dash-wireless', 'desert-winds-wireless', 'dish-net', 'ecliptixnet-wireless', 'excede-wild-blue', 'hughes-net', 'ptera-wireless', 'seymour-channels', 'startouch', 'verizon', 'other']
